...
Topher is currently a Vulnerability Enthusiast at a Fortune 50 Red Team and enjoys causing constructive mischief. Coming from an offensive security background, he has a research emphasis on reverse engineering, malware, exploitation development, and live memory hacking. He has spoken at various security conferences including DEF CON, SecTor, ToorCamp and BSides PDX. Some of his presentations can be found on [Speaker Deck](https://speakerdeck.com/tophertimzen).
...
Topher is also an active contributor to the community and has ran the [BsidesPDX](https://bsidespdx.org/) CTF in 2016 and 2017.
