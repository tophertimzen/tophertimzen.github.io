...
[AutoThink](https://github.org/GrayKernel/AutoThink) has the source code required to launch the automated attack against ThinkVantage to recover a windows password. The key points are 
...
{% video /resources/grayStorm/autoThink.mp4 640 480 /resources/grayStorm/storm.jpg %}
